        ...
        <div className="section_seven">
            ...
            <div className="innerpage stars exploress">
                ...
                <div className="container pt-3 pt-sm-5">
                    <h2 className="heading text-center pb-3 pb-sm-5">Explore</h2>
                        ...
                        <div className="col-lg-8 col-xl-9">
                            ...
                            {activeTab === 'allgrid' &&
                                <div className="allgrid row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
                                    {Collectionsdata[TabName]?.list?.map((e, i) =>
                                        // <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mt-5">
                                        <div className="col mt-5">
                                            {console.log("jshkajdak" , e    )}
                                            <Link to={`/crewdetail/${e?.CollectionNetwork+'/'+ e?.ContractAddress + '/'+ (e?.NFTOwner ? e?.NFTOwner : e?.NFTCreator) + '/'+ e?.NFTId} `} state={{ cardtype: "explore" }}><Crewcard 
                                    ...
                                    <div className="row">
                                         {Collectionsdata[TabName]?.list?.map((e, i) =>
                                            <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-4 mt-5">
                                                 <Link to={`/crewdetail/${e?.CollectionNetwork+'/'+ e?.ContractAddress + '/'+ (e?.NFTOwner ? e?.NFTOwner : e?.NFTCreator) + '/'+ e?.NFTId} `} state={{ cardtype: "explore" }}>
