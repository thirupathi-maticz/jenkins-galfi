...
import Colloctiontablecard from "../Components/collectionstaketablecard";
        ...
        <div className="section_seven">
            ...
            <div className="innerpage stars exploress">
                ...
                <div className="container pt-3 pt-sm-5">
                    <h2 className="heading text-center pb-3 pb-sm-5"> Stakes Collection</h2>
                    ...
                    <div className="row pb-5 pt-3 pt-lg-5">
                        ...
                        <div className="col-lg-12 col-xl-12">
                            ...
                            {activeTab === 'tablelist' &&
                                <>
                                   <div className="mt-3"><Colloctiontablecard 
                                ...
                                <div className="allgrid row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
                                    {Collectionsdata[TabName]?.list?.map((e, i) =>
                                        ...
                                        <div className="col mt-5">
                                            ...
                                            <Link to={`/stakelist/${e?.CollectionSymbol}` }  state={{ cardtype: "explore" }}><Collectioncard 
                            ...
                            {activeTab === 'limitgird' &&
                                <>
                                    <div className="row">
                                         {Collectionsdata[TabName]?.list?.map((e, i) =>
                                            <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mt-5">
                                                <Link to={`/stakelist/${e?.CollectionSymbol}` } state={{ cardtype: "explore" }}>
