...
import Crewtablecard from "../Components/crewstaketablecard";
...
function CollectionNft() {
    ...
    const Explore = async (data) => {
        ...
        let Resp = await CollectionByCreator(SendDATA);
        console.log("responsefromcollectionlist", SendDATA);
        ...
        if (Resp?.data) {
            ...
            if (data.status) {
                ...
                SetTokens({
                    ...
                    ...{
                        [TabName]: {
                            list: Tokens[TabName]?.list ? [...Tokens[TabName]?.list, ...Resp.data] : (Resp.data ? Resp.data : []),
                            // loader:
    ...
    const handlechange = (cat, name, e) => {
        ...
        if (name) {
            ...
            // setfindarray(daata)
            Explore({ page: pages, TabName: TabName, keywords: searchdata })
                        ...
                        <div className="col-lg-8 col-xl-9">
                            ...
                            {activeTab === 'allgrid' &&
                                <div className="allgrid row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
                                    ...
                                    {Tokens[TabName]?.list.length !== 0 ? Tokens[TabName]?.list?.map((e, i) =>
                                        // <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mt-5">
                                        <div className="col mt-5">
                                            {console.log("allgriddata", e)}
                                            <Link to={"/stakedetail"} state={{ cardtype: "explore" }}><Crewcard
                                                product={{
                                                    "from": activeTab,
                                                    ...
                                                    "image_url": `${config.IMG_URL + e.image_url}`
                                    ...
                                    <div className="row">
                                        {
                                            ...
                                            Tokens[TabName]?.list.length !== 0 ? Tokens[TabName]?.list?.map((e, i) =>
                                                <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-4 mt-5">
                                                    {console.log('kkkkk', e)}
                                                    <Link to={"/stakedetail"} state={{ cardtype: "explore" }}><Crewcard product={{
                                                        "from": activeTab,
                                    ...
                                    <div className="row imagegrid">
                                        {TabName && Tokens[TabName]?.list.length !== 0 ? Tokens[TabName]?.list?.map((e, i) =>
                                            <div className="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mt-5">
                                                ...
                                                <Link to={"/stakedetail"} state={{ cardtype: "explore" }}>
